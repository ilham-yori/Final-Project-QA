Feature: API CRUD Test
  ...
  Scenario: Complete User CRUD Cycle
      ...
      """
       {
        ...
        "gender": "male",
        "email": "Nathan.terbaru123@example.com",
    ...
    And the response field "firstName" should be "Nathan"
    ...
    When I send a PUT request for id "60d0fe4f5311236168a10a1c" with body:
      ...
      """
    Then the API response status code should be 200
    And the response field "lastName" should be "Liu Zheng"
    ...
    When I send a delete request for id "6a53b5115a85be68b069162f"
    Then the API response status code should be 200
